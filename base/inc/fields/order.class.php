...
class SiteOrigin_Widget_Field_Order extends SiteOrigin_Widget_Field_Base {
    ...
    public function enqueue_scripts() {
        wp_enqueue_script( 'so-order-field', theme_dir_url(__FILE__) . 'js/order-field' . SOW_BUNDLE_JS_SUFFIX . '.js', array( 'jquery', 'jquery-ui-sortable' ), SOW_FALLBACK_BUNDLE_VERSION );
        wp_enqueue_style( 'so-order-field', theme_dir_url(__FILE__) . 'css/order-field.css', array( ), SOW_FALLBACK_BUNDLE_VERSION );
    }
