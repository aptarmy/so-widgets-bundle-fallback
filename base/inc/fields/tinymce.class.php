...
class SiteOrigin_Widget_Field_TinyMCE extends SiteOrigin_Widget_Field_Text_Input_Base {
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'so-tinymce-field', theme_dir_url(__FILE__) . 'js/tinymce-field' . SOW_BUNDLE_JS_SUFFIX . '.js', array( 'jquery', 'editor', 'quicktags' ), SOW_FALLBACK_BUNDLE_VERSION );
		wp_enqueue_style( 'so-tinymce-field', theme_dir_url(__FILE__) . 'css/tinymce-field.css', array(), SOW_FALLBACK_BUNDLE_VERSION );
	}
