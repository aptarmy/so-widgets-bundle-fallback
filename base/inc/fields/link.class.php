...
class SiteOrigin_Widget_Field_Link extends SiteOrigin_Widget_Field_Text_Input_Base {
	...
	protected function render_before_field( $value, $instance ) {
		...
		?>
		<a href="#" class="select-content-button button-secondary"><?php esc_html_e('Select Content', 'seed') ?></a>
		<div class="existing-content-selector">

			<input type="text" class="content-text-search"
			       placeholder="<?php esc_attr_e('Search Content', 'seed') ?>"/>

			<ul class="posts"></ul>

			<div class="buttons">
				<a href="#" class="button-close button-secondary"><?php esc_html_e('Close', 'seed') ?></a>
			</div>
		</div>
