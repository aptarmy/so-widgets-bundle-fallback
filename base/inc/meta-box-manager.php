...
class SiteOrigin_Widget_Meta_Box_Manager extends SiteOrigin_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('SiteOrigin Meta Box Manager', 'seed'),
			array(
				'has_preview' => false,
	...
	public function add_meta_boxes( $post_type ) {
		...
		if ( !empty( $this->form_options ) ) {
			add_meta_box(
				...
				__( 'Widgets Bundle Post Meta Data', 'seed' ),
	...
	public function render_widgets_meta_box( $post ) {
		wp_enqueue_script(
			'sow-meta-box-manager',
			get_template_directory_uri() . '/inc/so-widgets-bundle-fallback/'.'base/js/meta-box-manager' . SOW_BUNDLE_JS_SUFFIX . '.js',
			array( 'jquery' ),
