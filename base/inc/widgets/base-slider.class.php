...
abstract class SiteOrigin_Widget_Base_Slider extends SiteOrigin_Widget {
	...
	function initialize() {
		...
		$frontend_scripts[] = array(
			...
			theme_dir_url( SOW_FALLBACK_BUNDLE_BASE_FILE ) . 'js/jquery.cycle' . SOW_BUNDLE_JS_SUFFIX . '.js',
			array( 'jquery' ),
		...
		if( function_exists('wp_is_mobile') && wp_is_mobile() ) {
			$frontend_scripts[] = array(
				...
				theme_dir_url( SOW_FALLBACK_BUNDLE_BASE_FILE ) . 'js/jquery.cycle.swipe' . SOW_BUNDLE_JS_SUFFIX . '.js',
				array( 'jquery' ),
				SOW_FALLBACK_BUNDLE_VERSION
			);
		}
		$frontend_scripts[] = array(
			'sow-slider-slider',
			theme_dir_url( SOW_FALLBACK_BUNDLE_BASE_FILE ) . 'js/slider/jquery.slider' . SOW_BUNDLE_JS_SUFFIX . '.js',
			array( 'jquery' ),
			SOW_FALLBACK_BUNDLE_VERSION
		);
		...
		$this->register_frontend_styles(
			array(
				array(
					'sow-slider-slider',
					theme_dir_url( SOW_FALLBACK_BUNDLE_BASE_FILE ) . 'css/slider/slider.css',
					array(),
					SOW_FALLBACK_BUNDLE_VERSION
				)
			)
