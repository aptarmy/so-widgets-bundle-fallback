...
class SiteOrigin_Widgets_Widget_Manager {
	...
	function get_theme_dir_url( $id ){
		return theme_dir_url( $this->get_plugin_path( $id ) );
	}
}
 ...
 * @return string
 */
function siteorigin_widget_get_theme_dir_url($id){
	return SiteOrigin_Widgets_Widget_Manager::single()->get_theme_dir_url($id);
}
