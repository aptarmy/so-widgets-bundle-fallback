 ...
 * - replace 'so-widgets-bundle-fallback' with $theme_text_domain
...
class SiteOrigin_Fallback_Widgets_Bundle {
	 ...
	 *
	 * @return SiteOrigin_Fallback_Widgets_Bundle
	 */
	static function single() {
		static $single;

		if( empty($single) ) {
			$single = new SiteOrigin_Fallback_Widgets_Bundle();
		}
	 ...
	 * Can also be called directly on the `SiteOrigin_Fallback_Widgets_Bundle` singleton class.
	 *
	...
	function admin_enqueue_scripts($prefix) {
		...
		wp_enqueue_style( 'siteorigin-widgets-manage-admin', plugin_dir_url( __FILE__ ) . 'admin/admin.css', array(), SOW_FALLBACK_BUNDLE_VERSION );
		wp_enqueue_script( 'siteorigin-widgets-trianglify', plugin_dir_url( __FILE__ ) . 'admin/trianglify' . SOW_BUNDLE_JS_SUFFIX . '.js', array(), SOW_FALLBACK_BUNDLE_VERSION );
		wp_enqueue_script( 'siteorigin-widgets-manage-admin', plugin_dir_url( __FILE__ ) . 'admin/admin' . SOW_BUNDLE_JS_SUFFIX . '.js', array(), SOW_FALLBACK_BUNDLE_VERSION );
	...
	function admin_page(){
		...
		$bundle = SiteOrigin_Fallback_Widgets_Bundle::single();
...
SiteOrigin_Fallback_Widgets_Bundle::single();
